...
<head>
    <base href="../../" />
    <title>SIRETRA HALAMAN ERROR</title>
    <meta charset="utf-8" />
...
<body id="kt_body" class="app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <style>
            body {
                background-image: url('{{ url('') }}/assets/src/media/auth/bg7.jpg');
            }

            [data-bs-theme="dark"] body {
                background-image: url('{{ url('') }}/assets/src/media/auth/bg7-dark.jpg');
            }
        </style>
        <!--end::Page bg image-->
            ...
            <div class="d-flex flex-column flex-center text-center p-10">
                ...
                <div class="card card-flush w-lg-650px py-5">
                    <div class="card-body py-15 py-lg-20">
                        ...
                        <!--begin::Illustration-->
                        <div class="mb-11">
                            <img src="{{ url('') }}/assets/src/media/auth/500-error.png" class="mw-100 mh-300px theme-light-show"
                                alt="" />
                            <img src="{{ url('') }}/assets/src/media/auth/500-error-dark.png" class="mw-100 mh-300px theme-dark-show"
                                alt="" />
                        </div>
                        <!--end::Illustration-->
                        <!--begin::Link-->
                        <div class="mb-0">
                            <a href="javascript:history.back()" class="btn btn-sm btn-primary">Return Home</a>
                        </div>
                        <!--end::Link-->
                    </div>
                </div>
