        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-title">
                    ...
                    {{-- <form method="GET" action="{{ route('laporan-laba-rugi-owner') }}" class="mb-4">
                        <div class="row">
                            <div class="col-2">
                            ...
                            <div class="col-sm-2 d-flex align-items-end">
                                ...
                                <a href="{{ route('laporan-laba-rugi-owner') }}" class="btn btn-danger mr-2">Reset</a>
                                <a href="{{ route('laporan-laba-rugi-owner-print', ['bulan' => request()->get('bulan'), 'tahun' => request()->get('tahun')]) }}"
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        @foreach ($bulanTahun as $key => $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('laporan-laba-rugi-owner-detail', ['bulan_tahun' => $item->bulan_tahun]) }}"
