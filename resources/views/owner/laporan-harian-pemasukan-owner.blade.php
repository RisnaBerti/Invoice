...
@section('content')
    ...
    <body>
        <div class="container my-4">
            ...
            <form method="GET" action="{{ route('laporan-harian-pemasukan-owner') }}" class="mb-4">
                <div class="row">
                    <div class="col-2">
                    ...
                    <div class="col-sm-2 d-flex align-items-end">
                        ...
                        <a href="{{ route('laporan-harian-pemasukan-owner') }}" class="btn btn-danger mr-2">Reset</a>
                        <a href="{{ route('laporan-harian-pemasukan-owner-print', ['tgl_awal' => request()->get('tgl_awal'), 'tgl_akhir' => request()->get('tgl_akhir')]) }}"
