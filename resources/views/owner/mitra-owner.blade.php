                                    ...
                                    <form id="kt_modal_add_mitra_form" class="form"
                                        ...
                                        <div class="d-flex flex-column mb-8 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                placeholder="Nama mitra" name="nama_mitra" id="nama_mitra" />
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="d-flex flex-column mb-8 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control-solid"
                                                placeholder="Alamat" name="alamat_mitra" id="alamat_mitra" />
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="d-flex flex-column mb-8 fv-row">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                                <span class="required">No Telephone</span>
                                                <span class="ms-1" data-bs-toggle="tooltip"
                                                    title="Specify a target name for future usage and reference">
                                                    <i class="ki-outline ki-information-5 text-gray-500 fs-6"></i>
                                                </span>
                                        ...
                                        <div class="d-flex flex-column mb-8 fv-row">
                                            ...
                                            <input type="email" class="form-control form-control-solid"
                                                placeholder="Email" name="email_mitra" id="email_mitra" />
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="d-flex flex-column mb-8 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control-solid"
                                                placeholder="Jenis Mitra" name="jenis_mitra" id="jenis_mitra" />
                                        </div>
                                        <!--end::Input group-->
        ...
        $(document).ready(function() {
            ...
            $('#kt_modal_add_mitra_submit_edit').click(function() {
                ...
                $.ajax({
                    ...
                    data: {
                        // id_mitra: id_mitra,
                        nama_mitra: nama_mitra_edit,
                        alamat_mitra: alamat_mitra_edit,
                        no_telp_mitra: no_telp_mitra_edit,
                        email_mitra: email_mitra_edit,
                        jenis_mitra: jenis_mitra_edit
                    },
