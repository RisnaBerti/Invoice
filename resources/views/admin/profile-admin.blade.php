...
<div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="card-body pt-9 pb-0">
            ...
            {{-- <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                ...
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5" href="{{ url('setting-admin') }}">Profile</a>
                </li>
                <!--end::Nav item-->            
            </ul> --}}
            <!--begin::Navs-->
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_setting_profile" class="collapse show">
            <!--begin::Form-->
            <form  method="POST" action="{{ route('update-setting-admin') }}" id="kt_profile_details_form" class="form">
                @csrf
                <!--begin::Card body-->
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            <!--begin::Form-->
            <form id="kt_ganti_password_form" class="form" method="POST" action="{{ route('update-password-admin') }}">
                @csrf
                <!--begin::Card body-->
                <div class="card-body border-top p-9">                   
                    <!--begin::Input group-->
