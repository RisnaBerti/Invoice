    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="card">
                            ...
                            <div class="modal-content rounded">
                                ...
                                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                    ...
                                    <form id="kt_modal_add_produk_form" class="form"
                                        action="{{ route('store-produk-admin') }}" method="POST" id="produkForm">
                                        @csrf
                                        <!--begin::Heading-->
                            ...
                            <div class="modal-content rounded">
                                ...
                                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                    ...
                                    <form id="kt_modal_edit_data_form" class="form"
                                        action="{{ route('update-produk-admin') }}" method="POST"
            ...
            <div class="card-body py-4">
                <!--begin::Table-->
                <table class="table table-hover align-middle table-row-dashed fs-6 gy-5" id="kt_table_produk">
                    <thead>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#kt_table_produk').on('click', '.edit-row', function() {
                var id = $(this).data('id');
                var url = "{{ route('edit-produk-admin', ':id') }}";
