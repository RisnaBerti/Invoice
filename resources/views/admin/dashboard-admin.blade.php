                            ...
                            <ul class="nav" id="kt_chart_widget_19_tabs">
                                <li class="nav-item">
                                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light active fw-bold px-4 me-1"
                                        ...
                                        href="#kt_chart_widget_19_tab_content_1">2023</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center me-5">
                                            <!--begin::Flag-->
                                            <img src="{{ url('') }}/assets/src/media/svg/brand-logos/atica.svg"
                                            ...
                                            <div class="me-5">
                                                <!--begin::Title-->
                                                <a href="#"
                                                    class="text-gray-800 fw-bold text-hover-primary fs-6">Abstergo Ltd.</a>
                                                <!--end::Title-->
                                                <!--begin::Desc-->
                                                <span
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center me-5">
                                            <!--begin::Flag-->
                                            <img src="{{ url('') }}/assets/src/media/svg/brand-logos/telegram-2.svg"
                                                class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                            <!--end::Flag-->
                                            <!--begin::Content-->
                                            <div class="me-5">
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center me-5">
                                            <!--begin::Flag-->
                                            <img src="{{ url('') }}/assets/src/media/svg/brand-logos/balloon.svg"
                                                class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                            <!--end::Flag-->
                                            <!--begin::Content-->
                                            <div class="me-5">
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center me-5">
                                            <!--begin::Flag-->
                                            <img src="{{ url('') }}/assets/src/media/svg/brand-logos/kickstarter.svg"
                                                class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                            <!--end::Flag-->
                                            <!--begin::Content-->
                                            <div class="me-5">
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center me-5">
                                            <!--begin::Flag-->
                                            <img src="{{ url('') }}/assets/src/media/svg/brand-logos/vimeo.svg"
                                                class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                            <!--end::Flag-->
                                            <!--begin::Content-->
                                            <div class="me-5">
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex align-items-center me-5">
                                            <!--begin::Flag-->
                                            <img src="{{ url('') }}/assets/src/media/svg/brand-logos/plurk.svg"
                                                class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                            <!--end::Flag-->
                                            <!--begin::Content-->
                                            <div class="me-5">
                    ...
                    <div class="card-body d-flex flex-column flex-center">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="py-10 text-center">
                                <img src="{{ url('') }}/assets/src/media/svg/illustrations/easy/2.svg"
                                    class="theme-light-show w-200px" alt="" />
                                <img src="{{ url('') }}/assets/src/media/svg/illustrations/easy/2-dark.svg"
                        ...
                        <div class="text-center mb-1">
                            ...
                            <a class="btn btn-sm btn-light"
                                href="../../demo39/dist/apps/user-management/users/view.html">Learn More</a>
                            <!--end::Link-->
                        </div>
                        <!--end::Links-->
                    </div>
                            ...
                            <ul class="nav" id="kt_chart_widget_19_tabs">
                                <li class="nav-item">
                                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1"
                                        ...
                                        href="#kt_chart_widget_25_tab_content_1">2023</a>
                                </li>
                                <li class="nav-item">
