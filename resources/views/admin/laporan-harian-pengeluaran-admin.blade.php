            ...
            <form method="GET" action="{{ route('laporan-harian-pengeluaran-admin') }}" class="mb-4">
                <div class="row">
                    ...
                    <div class="col-sm-2 d-flex align-items-end">
                        ...
                        <a href="{{ route('laporan-harian-pengeluaran-admin') }}" class="btn btn-danger mr-2">Reset</a>
                        <a href="{{ route('laporan-harian-pengeluaran-admin-print', ['tgl_awal' => request()->get('tgl_awal'), 'tgl_akhir' => request()->get('tgl_akhir')]) }}"
