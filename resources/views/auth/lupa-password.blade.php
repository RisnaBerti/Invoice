                ...
                <div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
                    ...
                    <div class="py-20">
                        ...
                        {{-- <form class="form w-100" novalidate="novalidate" id="kt_password_reset_form"
                            ...
                            action="#"> --}}
                        <form class="form w-100" novalidate="novalidate" method="POST" action="{{ route('action-lupa-password') }}">
                            @csrf
                            <!--begin::Heading-->
                            <div class="text-start mb-10">
                                <!--begin::Title-->
                                <h1 class="text-dark mb-3 fs-3x" data-kt-translate="password-reset-title">Lupa
                                    Password ?</h1>
                                <!--end::Title-->
                                <!--begin::Text-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Link-->
                                <div class="m-0">
                                    <button class="btn btn-primary me-2" type="submit">Send Reset Link</button>
