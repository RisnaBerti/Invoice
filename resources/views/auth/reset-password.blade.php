    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <a href="../../demo39/dist/index.html" class="d-block d-lg-none mx-auto py-20">
                <img alt="Logo" src="{{ url('') }}/assets/src/media/logos/default.svg" class="theme-light-show h-25px" />
                <img alt="Logo" src="{{ url('') }}/assets/src/media/logos/default-dark.svg" class="theme-dark-show h-25px" />
            </a>
            <!--end::Logo-->
            <!--begin::Aside-->
