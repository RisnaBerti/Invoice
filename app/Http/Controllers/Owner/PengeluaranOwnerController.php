...
class PengeluaranOwnerController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ->addColumn('action', function ($data) {
                    ...
                    $button .= '<a href="' . URL::route('show-pengeluaran-owner', ['id' => $data->id_pengeluaran]) . '" class="menu-link px-1 show-row"><i class="fas fa-eye text-success"></i></a>';
                    $button .= '<form action="' . URL::route('delete-pengeluaran-owner', ['id' => $data->id_pengeluaran]) . '" method="POST" style="display:inline;">';
    ...
    public function show(Request $request)
    {
        ...
        return view('owner.show-pengeluaran-owner', [
            'title' => 'Pengeluaran Owner',
    ...
    public function printShow(Request $request)
    {
        ...
        return view('owner.show-pengeluaran-owner-print', [
            'title' => 'Pengeluaran Owner',
            'pengeluaran' => $pengeluaran
        ], compact('pengeluaran'));
    }
    ...
    //fungsi update pengeluaran owner  dengan menggunakan ajax
    public function update(Request $request)
    {
        ...
        // Redirect kembali ke halaman pengeluaran-owner setelah update berhasil
